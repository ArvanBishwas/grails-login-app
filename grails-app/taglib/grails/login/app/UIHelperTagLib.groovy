...
class UIHelperTagLib {
    ...
    def studentActionMenu = { attrs, body ->
        out << '<li class="nav-item dropdown show">'
        out << g.link(class:"nav-link dropdown-toggle", "data-toggle":"dropdown"){authenticationService.getStudentName()}
    ...
    def leftNavigation = { attrs, body ->
        ...
        if(authenticationService.isAdministratorStudent()){
            navigations.add([controller: "student", action: "index", name: "student"])
        }
